...
from urlchecker.url_checker import UrlChecker, MIN_WEBSITE_SIZE, same_domain
...
class TestUrlChecker(TestCase):
    ...
    def test_redirect_found(self):
        with patch('requests.get') as retrieve_func:
            ...
            retrieve_func.return_value = stream_mock
            checker = UrlChecker("http://www.test.com")
            assert checker.is_working
    ...
    def test_redirect_different_domain(self):
        with patch('requests.get') as retrieve_func:
            ...
            retrieve_func.return_value = stream_mock
            checker = UrlChecker("http://www.test.com")
            assert "http://completely.different.com" == checker.new_url
